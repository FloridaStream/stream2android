...
public class Action
{
	...
	private String requestHostAddress = "";
	...
	public boolean performActionListener(ActionRequest actionReq)
	{
		...
		requestHostAddress = actionReq.getRemoteAddress();
		localHostAddress = actionReq.getLocalAddress();
	 ...
	 */
	public String getRequestHostAddress() {
